...
public class InjectorUtils {
    ...
    public static VeganPlaceRepository provideRepository(Context context) {
        ...
        return VeganPlaceRepository.getInstance(networkDataSource, networkDataSourceI, netWorkDatasourceN,netWorkDatasourceR,netWorkDatasourceL, database.daoReceta(), database.daoIngrediente(), database.daoNoticia(), database.daoResult(), database.daoLocation(),database.daoChat());
    }
